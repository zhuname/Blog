...
var cityNames="";
$.ajax({
	url : '/mts/system/city/list/json?web=&',
	type : "post",
	dataType : "json",
...
function check(id,name){
	...
	$.ajax({
		url : '/mts/system/appuser/update/json?cityId='+id+'&id='+getQueryString("id")+'&cityName='+name,
		type : "post",
		dataType : "json",
		success : function(result){
			...
			window.location.href="/mts/appWeb/appuser/appuserUpdate.jsp";
