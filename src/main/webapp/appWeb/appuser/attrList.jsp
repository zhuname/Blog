	...
	<script id="attr_list_tmpl" type="text/x-jquery-tmpl">
		<div class="pad_30 bg_f dis_f ali_ct jus_bt borderbot1">
			<div class="dis_f ali_ct">
				<img onclick="window.location.href='/mts/appWeb/appuser/otherUser.jsp?id={{= itemId}}'" src="{{if header}}{{= header}}{{else}}<%=basePath%>/js/appWeb/images/default_header.png{{/if}}" class="dis_b" style="width:1.7rem;height:1.7rem;border-radius: 0.9rem;margin-right:0.5rem;" />
