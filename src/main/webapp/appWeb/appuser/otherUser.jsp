...
<body>
	...
	<div class="center_bg">
			...
			<div class="pad_30 dis_f ali_end jus_bt">
				...
				<div class="f_20 f_light clr_f" style="border:1px solid #FFF;padding:0 0.1rem;border-radius: 0.1rem;white-space:nowrap" onclick="attr();" id="attr">已关注</div>
				</div>
			</div>
	...
	<script id="appuser_xunzhang_tmpl" type="text/x-jquery-tmpl">
		...
		<script id="circle_list_tmpl" type="text/x-jquery-tmpl">
			...
			<div class="mt_10" style="width:90%;">
				...
				<div class="dis_f ali_ct  flex_w quan_img mt_20" id="mains" style="width:100%">
						{{if type==2}}
				{{if mediaUrl}}
