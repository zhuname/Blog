	...
	<div class="wraper overh " style="background: #f9f9fb;height:100%;" id="detail">
		...
		<div class="pad_30 bg_f dis_f ali_ct jus_bt borderbot1">
			<div class="dis_f ali_ct">
				<img src="{{if appUser.header}}{{= appUser.header}}{{/if}}" class="dis_b" style="width:1.7rem;border-radius: 0.9rem;margin-right:0.5rem;" />
				<div class="f_28 clr_he">
					...
					{{/if}}
					<p class="mt_10 f_22">
						<span class="ver_mid">{{if appUser.sign}}{{= appUser.sign}}{{/if}}</span>
					</p>
				</div>
			</div>
