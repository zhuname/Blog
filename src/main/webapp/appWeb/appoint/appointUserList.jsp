...
<body>
	...
	<div class="wraper overh " style="background: #f9f9fb;height:100%;">
		...
		<script id="appoint_top_tmpl" type="text/x-jquery-tmpl">
			...
			&nbsp;
			<span class="f_24 clr_he">{{= appoinPerson}}人 预约了  {{= appintMoney}}元</span>
			</div>
		</script>
		...
		<script id="appoint_list_tmpl" type="text/x-jquery-tmpl">
			...
			<div class="dis_f ali_ct">
				<img src="{{if appUser}}{{= appUser.header}}{{/if}}" class="dis_b" style="width:1.7rem;border-radius: 0.9rem;margin-right:0.5rem;" />
			...
			<div class="dis_f ali_end jus_bt clr_r flex_col" >
					<div class="f_24 clr_r">预约金<span class="f_30">￥{{= money}}</span></div>
