...
<meta
	...
	name="viewport">
<title id="title" class="waitCheck">海报红包详情</title>
<style type="text/css">
...
<img src="<%=basePath%>/js/appWeb/images/App_icon.jpg" width="0" height="0" />
	...
	<div class="wraper overh " style="position: relative;">
		<div class="dis_f ali_ct jus_bt pad_20 bg_f borderbot1 pos_rela" id="headers">
			<a onclick="javascript:hrefIndexShare(1);" ><img src="<%=basePath%>/js/appWeb/images/back.png" class="dis_b" style="width:1rem;height:1rem;" /></a>
			<p class="f_30 clr_3">海报红包详情</p>
						<div class="whte"></div>
...
<span class="dis_b" style="margin-top:-0.5rem;">…</span>
        ...
        <div class="yuyue_bg pos_rela" style="padding-top:5.8rem;">
            ...
            <div class="f_20 clr_3 al_ct pad_20" >使用<span id="payString">账户余额</span>付款 ¥<span id="userBalance">0.00</span> <a href="javascript:;" class="clr_b" onclick="javascript:$('.pay-type').css('top',0)" style="padding:0 .2rem;">更换</a></div>
