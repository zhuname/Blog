...
<script type="text/javascript"
	src="<%=basePath%>/js/appWeb/posterPackage/app_posterPackageCards.js"></script>
		...
		<script id="card_list_tmpl" type="text/x-jquery-tmpl">
			...
			<div  style="width:13rem;">
				<div class="pad_20 dis_f ali_top bg_f">
					<img src="{{if appUser.header}}{{= appUser.header}}{{/if}}" class="dis_b yy_face_img" style="margin-right:0.5rem;"/>
