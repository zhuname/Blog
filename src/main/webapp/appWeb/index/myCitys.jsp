...
<script type="text/javascript"
	src="<%=basePath%>/js/appWeb/index/app_myCity.js"></script>
...
<style>
    ...
    .top_1 {
        background: none;
        background-image: url("<%=basePath%>/js/appWeb/images/1搜索.png");
        border: none;
        height: 1.25rem;
...
<div class="wraper overh bjt">
    <div class="navBox">
        ...
        <div class="subox">
            <input id="name" class="f_22 clr_he top_1" type="text" placeholder="搜索城市名称或者拼音"/>
            <span class="f_22" onclick="select();">搜索</span>
        </div>

        <div class="dqcs">
            <span class="f_22 title_dq">当前城市</span>
            <span class="f_24 szd" id="city">包头</span>
        </div>
    </div>

    <div class="qtcs f_22 addBox" id="list">

    </div>

</div>
		<script id="city_list_tmpl" type="text/x-jquery-tmpl">
			 <span onclick="checkIndex({{= id}},'{{= name}}');">{{= name}}</span>
		</script>
</body>
</html>