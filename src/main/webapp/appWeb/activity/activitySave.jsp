...
<%-- 	<div class="bg_f dis_f ali_ct jus_bt" style="padding:0.75rem 2.5rem;">
	...
	<div class="pad_30 borderbot1 bg_f">
		<div class=" f_24 clr_3 dis_f ali_ct jus_bt">
			...
			<input class="ipt3 f_26 clr_6" placeholder="请输入奖励标题(限8字)" type="text" />
			</p>
		...
		<input class="ipt3 f_24 clr_6 mt_20 w_100" placeholder="请填写奖励内容" type="text" />
...
<div class="pad_30 borderbot1 bg_f f_28 clr_3 dis_f ali_ct jus_bt">
	...
	<p class="dis_f ali_ct clr_ph_red"  onclick="window.location.href='/mts/appWeb/activity/baiduMap.jsp';" >
		点击进行地图定位
	</p>
</div>
...
<div class="pad_30 borderbot1 bg_f f_28 clr_3 dis_f ali_ct jus_bt">
	...
	<div class="pad_30">
			<input type="button" class="f_26 clr_f dis_b waiting_check_a" style="background: #f95d47;border:0;" value="发布活动" />
		</div>
