		...
		<div class="dis_f ali_ct jus_bt pad_20 bg_f borderbot1">
			...
			<script id="card_list_tmpl" type="text/x-jquery-tmpl">
					...
					<div class="dis_f ali_ct" onclick="window.location.href='/mts/appWeb/appuser/otherUser.jsp?id={{= id}}'">
						<img onclick="window.location.href='/mts/appWeb/appuser/otherUser.jsp?id={{= id}}'" src="{{if header}}{{= header}}{{else}}<%=basePath%>/js/appWeb/images/default_header.png{{/if}}" class="dis_b" style="width:1.7rem;height:1.7rem;border-radius: 0.9rem;margin-right:0.5rem;" />
