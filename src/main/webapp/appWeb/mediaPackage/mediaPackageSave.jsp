...
<script type="text/javascript"
	src="<%=basePath%>/js/appWeb/mediaPackage/app_mediaPackageSave.js"></script>
...
<body>
	...
	<div class="bg_f pad_30 dis_f ali_ct jus_bt" >
		<a style="position: relative" id="mediaUrl">
			
			<img src="<%=basePath%>/js/appWeb/images/xzsp.png" onclick="headOnc();" class="dis_b" style="width:100%;" />
		</a>
	</div>
...
<div class="pad_30 borderbot1 bg_f f_28 clr_3 dis_f ali_ct jus_bt">
	...
	<p class="dis_f ali_ct clr_ph_red"  onclick="window.location.href='/mts/appWeb/mediaPackage/mediaPackageCategory.jsp';">
		<span id="categoryId">请选择视频分类</span>
...
<div class="pad_30 borderbot1 bg_f f_28 clr_3 dis_f ali_ct jus_bt">
	...
	<p class="dis_f ali_ct clr_ph_red"  onclick="window.location.href='/mts/appWeb/mediaPackage/mediaPackageCity.jsp';">
...
<div id="cardShow" style="display:none;" class="pad_2030 f_24 clr_he2 bg_f dis_f ali_ct jus_bt borderbot1 kq_open">
	...
	<p class="dis_f ali_ct"  onclick="window.location.href='/mts/appWeb/mediaPackage/mediaPackageCards.jsp';">
